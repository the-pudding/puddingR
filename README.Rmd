...
If you want to export codebooks and the scripts used to generate data at the same time the data is generated, you can use `export_data()` instead. 
...
These pieces can be accomplished separately using `export_processed()`, `render_codebook()` and `export_code()`.
